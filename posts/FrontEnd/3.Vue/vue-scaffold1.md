...
- 配置eslint https://eslint.nodejs.cn/docs/latest/use/configure/configuration-files
- 配置prettier https://www.prettier.cn/docs/install.html
- 配置sass预处理器 https://www.sass.hk/docs/
- 配置stylelint https://github.com/prettier/stylelint-config-prettier
- 配置husky 在提交代码之前 检查代码规范 https://typicode.github.io/husky/how-to.html
- 配置commitlint 配置代码提交规范
- 统一包管理器工具
